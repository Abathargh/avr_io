...
const
  ...
  PIFR1*   = MappedIoRegister[uint8](0xA2)
  PIM1*    = MappedIoRegister[uint8](0xA3)
  ...
  MUBRR*   = MappedIoRegister[uint16](0xCC)
  ...
  PSOC1*   = MappedIoRegister[uint8](0xE0)
  OCR1SA*  = MappedIoRegister[uint16](0xE2)
  OCR1SAL* = MappedIoRegister[uint8](0xE2)
  OCR1SAH* = MappedIoRegister[uint8](0xE3)
  OCR1RA*  = MappedIoRegister[uint16](0xE4)
  OCR1RAL* = MappedIoRegister[uint8](0xE4)
  OCR1RAH* = MappedIoRegister[uint8](0xE5)
  OCR1SB*  = MappedIoRegister[uint16](0xE6)
  OCR1SBL* = MappedIoRegister[uint8](0xE6)
  OCR1SBH* = MappedIoRegister[uint8](0xE7)
  OCR1RB*  = MappedIoRegister[uint16](0xE8)
  OCR1RBL* = MappedIoRegister[uint8](0xE8)
  OCR1RBH* = MappedIoRegister[uint8](0xE9)
  PCNF1*   = MappedIoRegister[uint8](0xEA)
  PCTL1*   = MappedIoRegister[uint8](0xEB)
  PFRC1A*  = MappedIoRegister[uint8](0xEC)
  PFRC1B*  = MappedIoRegister[uint8](0xED)
  PICR1*   = MappedIoRegister[uint16](0xEE)
  PICR1L*  = MappedIoRegister[uint8](0xEE)
  PICR1H*  = MappedIoRegister[uint8](0xEF)
