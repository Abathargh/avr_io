...
const
  ...
  BGCSR*   = MappedIoRegister[uint8](0xD2)
  CHGDCSR* = MappedIoRegister[uint8](0xD4)
  ...
  CADIC*   = MappedIoRegister[uint16](0xE4)
  CADICL*  = MappedIoRegister[uint8](0xE4)
  CADICH*  = MappedIoRegister[uint8](0xE5)
  CADCSRA* = MappedIoRegister[uint8](0xE6)
  CADCSRB* = MappedIoRegister[uint8](0xE7)
  CADCSRC* = MappedIoRegister[uint8](0xE8)
  CADRCC*  = MappedIoRegister[uint8](0xE9)
  CADRDC*  = MappedIoRegister[uint8](0xEA)
