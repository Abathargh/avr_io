...
const
  ...
  DEVID0* = MappedIoRegister[uint8](0xF0)
  DEVID1* = MappedIoRegister[uint8](0xF1)
  DEVID2* = MappedIoRegister[uint8](0xF2)
  DEVID3* = MappedIoRegister[uint8](0xF3)
  DEVID4* = MappedIoRegister[uint8](0xF4)
  DEVID5* = MappedIoRegister[uint8](0xF5)
  DEVID6* = MappedIoRegister[uint8](0xF6)
  DEVID7* = MappedIoRegister[uint8](0xF7)
  DEVID8* = MappedIoRegister[uint8](0xF8)
