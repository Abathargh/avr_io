...
const
  ...
  LCDDR0*  = MappedIoRegister[uint8](0xEC)
  LCDDR1*  = MappedIoRegister[uint8](0xED)
  LCDDR2*  = MappedIoRegister[uint8](0xEE)
  LCDDR3*  = MappedIoRegister[uint8](0xEF)
  LCDDR4*  = MappedIoRegister[uint8](0xF0)
  LCDDR5*  = MappedIoRegister[uint8](0xF1)
  LCDDR6*  = MappedIoRegister[uint8](0xF2)
  LCDDR7*  = MappedIoRegister[uint8](0xF3)
  LCDDR8*  = MappedIoRegister[uint8](0xF4)
  LCDDR9*  = MappedIoRegister[uint8](0xF5)
  ...
  LCDDR14* = MappedIoRegister[uint8](0xFA)
  ...
  LCDDR19* = MappedIoRegister[uint8](0xFF)
