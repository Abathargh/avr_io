...
const
  ...
  timer4* = Timer16Bit3ComparePwm(tccra: TCCR4A, tccrb: TCCR4B, tccrc: TCCR4C,
    tcnth: TCNT4H, tcntl: TCNT4L, ocrah: OCR4AH, ocral: OCR4AL, ocrbh: OCR4BH,
    ocrbl: OCR4BL, icrh: ICR4H, icrl: ICR4L, timsk: TIMSK4, tifr: TIFR4,
    gtccr: GTCCR)
  timer5* = Timer16Bit3ComparePwm(tccra: TCCR5A, tccrb: TCCR5B, tccrc: TCCR5C,
    tcnth: TCNT5H, tcntl: TCNT5L, ocrah: OCR5AH, ocral: OCR5AL, ocrbh: OCR5BH,
    ocrbl: OCR5BL, icrh: ICR5H, icrl: ICR5L, timsk: TIMSK5, tifr: TIFR5,
    gtccr: GTCCR)
